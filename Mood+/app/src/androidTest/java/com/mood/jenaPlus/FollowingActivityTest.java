...
public class FollowingActivityTest extends ActivityInstrumentationTestCase2 {

    private Solo solo;

    public FollowingActivityTest() {
    ...
    public void testViewFollowingTest() {
        ...
        solo.searchText("Following");
        solo.clickOnText("Following");

        solo.assertCurrentActivity("Wrong Activity", FollowingListActivity.class);
